...
<nav class="navbar navbar-inverse ">
    <div class="container-fluid">
      <div class="navbar-header ">
        ...
        <a class="navbar-brand logo" id = "logo" > MK </a>
      </div>

      <div class="collapse navbar-collapse " id="myNavbar">
        <div style="float: right;">
          <ul class="nav navbar-nav" >
              <li style="color: black;"><a href="/index/">Home</a></li>
              <li class="dropdown">
  ...
  <!--<div id = "data" class = "col-12 jumbotron bg-cover text-center" style="text-align: center; display: flex; flex-direction: column; flex-wrap: wrap; background-color: rgba(245, 122, 122, 0.993);  background-size: cover; height:100%; background-repeat: no-repeat;">-->
    <div id = "data" class = "row jumbotron bg-cover ">

          <div class="container col-9  col-md-12 col-sm-12" >
            <div class="main"   >
             <h2 id="signInLabel">Sign In </h2><br>
              ...
              <!--<input type="button" value="Login" id="submit" onclick="/js/validate()"/>-->
              <input type = "button" value="Login" id = "submit"/>
              </form>
            </div>
          </div>

        <!--<div class="col-3 col-sm-12 col-md-12 registration" >-->
          <div class="container flex-wrap col-3 col-sm-12 col-md-12 registration" style="float:right;">
            <h3 style="text-decoration-style:solid; font-weight:solid;">New to Online Banking? </h3><br>
            <a href="/contact/" class="btn btn-success btn-lg"  >REGISTER FOR ONLINE BANKING</a><br>
            <h4>Covniently register for online banking <br> using your bank account number.</h4>
          </div>
        <!--</div>-->
...
<footer class="footer mt-auto px-3 text-center" style="float: bottom; position: absolute; width:100%; bottom:0; background-color: #3D3D3D; color: white; text-align: center">
